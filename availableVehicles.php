      ...
      <div class="content-wrapper"           
        ...
        <div class="row">
          <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">List of Available Vehicles</h4>
                <p class="card-description"> Vehicle's Info </p>
                  <table class="col-md-6 table table-striped" >
                    ...
                    <tbody>
                <p class="text-info"><?php include './Scripts/availableVehiclesArray.php';?></p>
                                    </tbody>
