      ...
      <div class="content-wrapper"           
        ...
        <div class="row">
          <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">List of Available Mini Buses</h4>
                <p class="card-description"> Mini Buse Info </p>
                  <table class="col-md-6 table table-striped" >
                    <thead>
                        <!--Γραμμή τίτλων του πίνακα-->
                        <tr >
                            <th class="text-info font-weight-bold">Number</th>
                            <th class="text-info font-weight-bold">Vehicle Type</th>
                            <th class="text-info font-weight-bold">Number of Seats</th>
                            <th class="text-info font-weight-bold">Plate Nr</th>
                            <th class="text-info font-weight-bold">Vehicle Nr</th>
                        </tr>
                    </thead>
                    <tbody>
                <p class="text-info"><?php include './Scripts/availableMiniBusesArray.php';?></p>
                                    </tbody>
