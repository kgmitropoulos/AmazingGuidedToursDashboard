      ...
      <div class="content-wrapper"           
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">List of Available Points of Interest</h4>
                <p class="card-description"> Points of Interest's Info </p>
                  <table class="col-md-6 table table-striped" >
                    <thead>
                        ...
                        <tr >
                          ...
                          <th class="text-info font-weight-bold">Brief Info</th>
                          <th class="text-info font-weight-bold">Detailed Info</th>
                        </tr>
                    </thead>
                    <tbody>
                      
                      <p ><?php include './Scripts/availablePoisArray.php';?></p>
                    </tbody>
                    <!--Γραμμή στο κάτω μέρος του πίνακα-->
                    <tfoot>
                        <tr class="info text-wrap">
                            <th> </th>
                            <th> </th>
                          <th> </th>
                          <th> </th>
